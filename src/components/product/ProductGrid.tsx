...
const filterLabels = {
  ...
  zh: { ALL: "全部", "WEDDING DRESSES": "婚纱", VEILS: "头纱", EVENING: "晚礼服", MODAL: "莫代尔", CHIFFON: "雪纺", JERSEY: "针织", BRIDAL: "新娘" },
  ...
  ar: { ALL: "الكل", "WEDDING DRESSES": "فساتين الزفاف", VEILS: "الطرحات", EVENING: "السهرة", MODAL: "مودال", CHIFFON: "شيفون", JERSEY: "جيرسي", BRIDAL: "زفاف" }
} as const;
