...
export default function HijabPage() {
  return <div className="shell"><div className="page-intro"><p className="eyebrow"><PageText id="collection" /></p><h1>Hijab</h1><p><PageText id="hijabIntro" /></p></div><section className="pb-32"><SectionHeading eyebrow={<PageText id="selectedPieces" />} title={<PageText id="hijabPageTitle" />} /><ProductGrid products={getCollectionProducts("hijab")} filters={["ALL", "MODAL", "CHIFFON", "JERSEY", "BRIDAL"]} /></section></div>;
}
